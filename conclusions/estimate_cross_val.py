...
from lasso_cross_val import X, y, cv, alpha
...
for name, model in models:
    prediction = cross_validate(model, X, y, groups=None, scoring=['neg_mean_squared_error', 'r2'], 
...
#                "RSS test":round(np.mean(scores.),3), 
#                    "MSE train":MSE_train, 
                "MSE test":np.mean(prediction['test_neg_mean_squared_error']), 
#                    "R_squared train":r2_train, 
                "R_squared test":np.mean(prediction['test_r2'])})
